  ...
  - -----------------------------------------------------------------
  - These functions call the x, y and z components of of a given vector.
  ...
  vecDistBtwn v0 v1 = vecMagnitude vd
      where
        ...
        -- The distance between two vectors is the magnitude of v0 - v1.
  ...
  If the scalar multiple was 2, then 2d/d = 2 where d is the magnitude of the original vector.
  ...
  results in a 0/0 division, which is indeterminate.
  ...
  - - Actual Output:   1212.6037505150534
  ...
  - - Actual Output:   1.0367739628289283e-3
  ...
  - - Actual Output:   37.26929030716845
  ...
  - - Actual Output:   [3.60555, 5.09902, 6.55744]
  ...
  - - Actual Output:   [ (1.0,2.0,3.0), (4.0,3.0,5.0)]
  - -----------------------------------------------------------------
  -
  - -----------------------------------------------------------------
  - - Function: vecF
  ...
  - - Actual Output:    [(2.0,3.0,4.0), (4.0,3.0,5.0)]
  - -----------------------------------------------------------------
  -
  - -----------------------------------------------------------------
  - - Function:
